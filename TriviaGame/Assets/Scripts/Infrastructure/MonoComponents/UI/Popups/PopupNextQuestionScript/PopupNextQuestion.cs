...
namespace Assets.Scripts.Infrastructure.MonoComponents.UI.Popups.PopupNextQuestionScript
{
    public class PopupNextQuestion : BasePopup
    {
        ...
        {
            base.Initialize();
            _popupNextQuestionControler = new PopupNextQuestionControler(_popupNextQuestionModel, ServiceLocator.Container.Single<ILevelGamePlayService>(), ServiceLocator.Container.Single<IPopupService>(), ServiceLocator.Container.Single<IScreanService>());
